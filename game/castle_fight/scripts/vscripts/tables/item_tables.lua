g_Race_Items = {
  ...
  npc_dota_hero_slark = {
    "item_build_ancient_pyramid",
    "item_build_oracle_of_sirens",
    "item_build_coral_statue",
    "item_build_tidal_guardian",
  },
  npc_dota_hero_treant = {
    "item_build_ancient_guardian",
    "item_build_ancient_protector",
    "item_build_ancient_of_wind",
    "item_build_ancient_of_wonders",
  },
  npc_dota_hero_vengefulspirit = {
    "item_build_silver_glade",
    "item_build_obelisk_of_wilderness",
    "item_build_elunes_lantern",
    "item_build_starfall_obelisk",
  },
  npc_dota_hero_abaddon = {
    "item_build_death_pit",
    "item_build_skull_pile",
  ...
  npc_dota_hero_wisp = {
    ...
    "item_build_elemental_guard_tower",
  },
}